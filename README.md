...
#The Game Concept
The premise is pretty simple. Its a basic snake game, counters, graphics, sound bites, included. But the apple bounces around randomly and uncontrollably,
...
the location of the elements to the individual's system, this can be a little complicated for beginners, but I assure you its not a big deal. Simple go where the 
