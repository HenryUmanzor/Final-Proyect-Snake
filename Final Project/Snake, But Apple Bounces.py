...
"""
#Apple Image
Apple_img =pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Apple.png").convert_alpha()),(cell_size,cell_size))
#Element Classes
class Background:
    def __init__(self):
...
class Snake:
    def __init__(self):
        ...
        self.can_move = True
        #Head Img
        self.head_up = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Head_up.png").convert_alpha()),(cell_size,cell_size))
        self.head_down = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Head_Down.png").convert_alpha()),(cell_size,cell_size))
        self.head_left = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Head_Left.png").convert_alpha()),(cell_size,cell_size))
        self.head_right  = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Head_Right.png").convert_alpha()),(cell_size,cell_size))
        #Tail Img
        self.tail_up = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Tail_Up.png").convert_alpha()),(cell_size,cell_size))
        self.tail_down = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Tail_Down.png").convert_alpha()),(cell_size,cell_size))
        self.tail_left = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Tail_Left.png").convert_alpha()),(cell_size,cell_size))
        self.tail_right  = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Tail_Right.png").convert_alpha()),(cell_size,cell_size))
        #Intersecctions
        self.cross_ld = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Cross_Left_Down.png").convert_alpha()),(cell_size,cell_size))
        self.cross_lu = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Cross_Left_Up.png").convert_alpha()),(cell_size,cell_size))
        self.cross_rd = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Cross_Right_Down.png").convert_alpha()),(cell_size,cell_size))
        self.cross_ru = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Cross_Right_Up.png").convert_alpha()),(cell_size,cell_size))
        #Body
        self.body_x = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Body_X.png").convert_alpha()),(cell_size,cell_size))
        self.body_y = pygame.transform.scale((pygame.image.load("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\Snake\\Body_Y.png").convert_alpha()),(cell_size,cell_size))
        #Sound
        self.eating_sound = pygame.mixer.Sound("C:\\Users\\ADMIN\\Documents\\Coding\\Python\\Uni\\Final Project\\Elements\\crunch.wav")
